...
def generate_adj_pems08():
    distance_df_filename, num_of_vertices = "D:/myfile/BasicTS/examples/datasets/raw_data/PEMS08/PEMS08.csv", 170
    ...
    with open("D:/myfile/BasicTS/datasets/raw_data/PEMS08/adj_PEMS08.pkl", "wb") as f:
        pickle.dump(adj_mx, f)
    with open("D:/myfile/BasicTS/datasets/raw_data/PEMS08/adj_PEMS08_distance.pkl", "wb") as f:
